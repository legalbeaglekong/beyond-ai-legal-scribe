...
const data: IndustryPageData = {
  slug: "robotics",
  seo: {
    title: "Robot Leasing & Robotics Law Singapore — RaaS, Autonomous Systems & Liability | Beyond Horizons Legal",
    description: "Pioneer robotics lawyers in Singapore. Robot leasing, RaaS contracts, autonomous systems liability, regulatory compliance. Beyond Horizons Legal by Bethel Chambers LLC.",
  },
  hero: {
    title: "Robot Leasing & Robotics Law — RaaS, Autonomous Systems & Liability Counsel",
  ...
  overview: {
    ...
    services: [
      ...
      { icon: Settings, title: "Robotics-as-a-Service (RaaS)", description: "RaaS contract structures, SLA frameworks, performance-based pricing models, data ownership provisions, and end-of-service transition clauses." },
    ...
    stats: ["Pioneer in robot leasing legal frameworks", "Aircraft leasing expertise applied to robotics", "RaaS contract structuring", "Autonomous systems liability advisory"],
  },
  comparison: {
    ...
    rows: [
      ...
      { feature: "RaaS Structuring", other: "Use standard SaaS templates", bh: "Purpose-built RaaS contracts addressing physical asset risks, performance warranties, and maintenance obligations unique to robotics" },
  ...
  spotlight: {
    ...
    cards: [
      { title: "Market Growth", description: "Global robotics market projected at $200B+ by 2030, with the RaaS model growing 25%+ annually." },
  ...
  faqs: {
    ...
    items: [
      ...
      { question: "What regulations apply to industrial robots and cobots in Singapore?", answer: "Singapore regulates workplace robotics through the Workplace Safety and Health Act, with specific standards for collaborative robots (cobots). Additional regulations apply to autonomous vehicles, drones, and service robots deployed in public spaces." },
      { question: "How should data ownership be handled in RaaS agreements?", answer: "RaaS agreements should clearly address ownership of operational data, performance data, and any AI-generated insights. Key provisions include data access rights, portability, confidentiality, and compliance with PDPA requirements." },
    ],
  },
  cta: {
    heading: "Deploying robots? Deploy the right legal framework first.",
    description: "From robot leasing structures to RaaS contracts, our pioneering robotics legal team is ready to help. Book a free strategic consultation.",
  },
  relatedPages: [
