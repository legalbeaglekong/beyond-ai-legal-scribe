...
const data: IndustryPageData = {
  ...
  seo: {
    ...
    description: "AI governance and risk management legal counsel in Singapore. Advising on AI regulation, compliance, model risk, and responsible AI deployment. Beyond Horizons Legal.",
  },
  hero: {
  ...
  overview: {
    ...
    services: [
      ...
      { icon: Scale, title: "Regulatory Compliance & AI Policy", description: "Drafting AI-specific policies, acceptable use standards, and compliance frameworks aligned with Singapore guidelines, the EU AI Act, FEAT principles, and sector-specific regulations across financial services, healthcare, and technology." },
