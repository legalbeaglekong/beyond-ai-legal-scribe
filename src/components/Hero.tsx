      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-primary-foreground mb-6 leading-tight">
            ...
            <span className="text-gold">Space Innovation</span>
          </h1>

          {/* Subheadline */}
          <p className="text-xl md:text-2xl text-primary-foreground/90 mb-8 leading-relaxed max-w-3xl mx-auto">
            Empowering visionary clients who are shaping the future of aviation, maritime, space exploration, and sustainable technologies with bespoke legal strategies.
          </p>

          {/* Key Value Props */}
          <div className="flex flex-wrap justify-center items-center gap-6 mb-10 text-primary-foreground/80">
            <div className="flex items-center space-x-2">
              <Globe className="h-5 w-5 text-gold" />
              <span className="font-medium">Global Market Leader</span>
            </div>
            <div className="flex items-center space-x-2">
              <Rocket className="h-5 w-5 text-gold" />
              <span className="font-medium">Innovation-First Approach</span>
            </div>
            <div className="flex items-center space-x-2">
              <Scale className="h-5 w-5 text-gold" />
              <span className="font-medium">Chambers & Partners Ranked</span>
            </div>
          </div>
