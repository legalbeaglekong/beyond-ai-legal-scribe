          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3 flex-shrink-0">
              <Button
                ...
                className="text-xs font-medium uppercase tracking-wide border-border hover:bg-secondary hover:text-secondary-foreground transition-smooth"
              >
                Decline
              </Button>
              <Button
                ...
                className="bg-primary text-primary-foreground hover:bg-primary/90 text-xs font-medium uppercase tracking-wide transition-smooth"
              >
                Accept All
              </Button>
              <Button
