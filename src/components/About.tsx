...
import eurasianTechTeamPortrait from "@/assets/eurasian-tech-team-portrait.jpg";
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-start">
          ...
          <div className="space-y-12">
            <div className="relative">
              <img
                src={eurasianTechTeamPortrait}
                alt="Beyond Horizons Legal Team - Young Eurasian Tech-Enabled Legal Professionals"
