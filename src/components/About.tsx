...
import fiveLawyersLuxuryOffice from "@/assets/five-lawyers-luxury-office.jpg";
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-start">
          ...
          <div className="space-y-12">
            <div className="relative">
              <img
                src={fiveLawyersLuxuryOffice}
                alt="Beyond Horizons Legal Team - Five Lawyers in Ultra-Luxury Office"
