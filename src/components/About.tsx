...
import youngLawyersOutdoorTeam from "@/assets/young-lawyers-outdoor-team.jpg";
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-start">
          ...
          <div className="space-y-12">
            <div className="relative">
              <img
                src={youngLawyersOutdoorTeam}
                alt="Beyond Horizons Legal Team - Young Lawyers Outdoors"
